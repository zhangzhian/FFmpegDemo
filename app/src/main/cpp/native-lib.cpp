...
                                                                                                                                                                                                           extern "C"
JNIEXPORT jint JNICALL
Java_com_yodosmart_ffmpegdemo_MainActivity_h246ToMp4(
		JNIEnv *env, jobject) {
	...
	const char *in_filename_v = "/storage/emulated/0/Download/avtest/sintel.h264";
	const char *out_filename = "/storage/emulated/0/Download/avtest/sintel.mp4";//Output file URL
	av_register_all();
	//Input
